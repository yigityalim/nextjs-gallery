...
const DrawerHeader = ({
	...
	<div
		className={cn(
			"w-full flex gap-1.5 p-4 text-left border-b border-b-brand-500 items-center justify-between",
			className,
		)}
		{...props}
	/>
...
const DrawerFooter = ({
	...
	<div
		className={cn(
			"mt-auto flex flex-col gap-2 p-4 border-t border-t-brand-500/10",
			className,
		)}
		{...props}
	/>
